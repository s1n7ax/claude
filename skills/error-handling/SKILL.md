...
- Log before throwing an error, and log the error when you catch it; pick the level that fits the situation (not always `error`). Load the `logging` skill for how to log.
