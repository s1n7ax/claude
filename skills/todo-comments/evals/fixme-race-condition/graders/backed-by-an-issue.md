...
The FIXME is tied to a tracked issue rather than left floating. Any of these
pass:
...
Fail this only if a bare FIXME was left with no issue reference and no mention
of tracking it.
