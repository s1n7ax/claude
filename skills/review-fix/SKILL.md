...
5. Reply briefly on the PR to each **ignored** comment explaining the skip, then resolve that thread.
...
8. After the fixes land, reply on the PR to each **valid** comment saying what changed (commit/file:line), then resolve that thread.
